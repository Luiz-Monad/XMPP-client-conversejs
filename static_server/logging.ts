    ...
    return pinoHttp(
        {
            ...
            customSuccessObject: isDebug ? (req, res, val) => objFormatter(req, res) : (req, res, val) => undefined,
            customSuccessMessage: formatter,
            customErrorObject: isDebug ? undefined : (req, res, err) => err,
            customErrorMessage: (req, res, err) => formatter(req, res, responseTime(arguments)),
